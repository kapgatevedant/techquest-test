...
def main():
    st.markdown("# Welcome to the Tech Quest event!")
    st.markdown("This is an interactive challenge where you'll need to solve tech-themed puzzles to progress through the stages.")
    st.markdown("---")
